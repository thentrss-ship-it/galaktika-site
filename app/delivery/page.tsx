...
const deliverySteps = [
  {
    ...
    text: "Напишите менеджеру в Telegram или соберите позиции в каталоге и отправьте ему список.",
  },
  {
...
const faq = [
  ...
  },
  {
    ...
    answer:
      "Да. Напишите менеджеру в Telegram — он отправит актуальный прайс и наличие.",
  },
  {
