...
const orderSteps = [
  {
    ...
    text: 'Перейдите в Telegram и напишите менеджеру. Можно сразу отправить список интересующих товаров из каталога.',
  },
  {
    number: '02',
...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Да. Напишите менеджеру в Telegram — он отправит актуальный прайс и наличие.',
  },
  {
          ...
          <div className="grid items-end gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <p className="mt-7 max-w-2xl text-lg font-medium leading-relaxed text-zinc-300 md:text-xl">
                Понятная схема работы для магазинов, сетей и оптовых клиентов: от сообщения менеджеру и получения прайса до отгрузки со склада в Москве.
              </p>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-xl leading-relaxed text-zinc-400">
              Схема простая: пишете менеджеру в Telegram, получаете прайс, собираете заказ и согласуете доставку.
            </p>
          </div>
